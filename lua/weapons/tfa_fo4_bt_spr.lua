...
SWEP.Author				= "shrimp" --Author Tooltip
...
SWEP.PrintName				= "B&T SPR"		-- Weapon name (Shown on HUD)
...
--[[VIEWMODEL]]--
SWEP.ViewModel			= "models/weapons/fo4/c_fo4_bt_spr.mdl" --Viewmodel path
...
--}
--[[WORLDMODEL]]--
//SWEP.WorldModel			= "models/weapons/w_sks_01.mdl" -- Weapon world model path
